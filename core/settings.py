...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # This points to the directory you just created

# Add the following media settings
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media/'  # Defines the location where media files will be stored
